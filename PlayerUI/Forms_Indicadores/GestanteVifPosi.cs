...
{
    public partial class GestanteVifPosi : Form
    {
        public GestanteVifPosi()
        {
            InitializeComponent();
            cargar_datosDisa();
        }
        ...
        private void GestanteVifPosi_Load(object sender, EventArgs e)
        {
                ...
                else  //45 spacios segun combobox
                {
                    using (SqlConnection cnn = Conexion.ObternerConexion())
                    {
                       ...
                       //da.SelectCommand.Parameters.Add("@red", SqlDbType.VarChar).Value = cbred.Text;
                        ...
                        string query = "SELECT count(*) from (SELECT NUMERO_DOCUMENTO FROM DENOMINADORSI07 group by NUMERO_DOCUMENTO)as t";
                        ...
                        string query2 = "SELECT count(*) from (SELECT NUMERO_DOCUMENTO FROM DENOMINADORSI07TAMIZAJE group by NUMERO_DOCUMENTO)as t";
                        ...
                        string query4 = "SELECT count(*) from (SELECT NUMERO_DOCUMENTO FROM GESPOSITIVAVIOLENCIA group by NUMERO_DOCUMENTO)as t";
                        ...
                        string query5 = "SELECT count(*) from (SELECT NUMERO_DOCUMENTO FROM GESTVIFTRA group by NUMERO_DOCUMENTO)as t";
                        ...
                        string query3 = "SELECT count(*) from (select d.NUMERO_DOCUMENTO from GESPOSITIVAVIOLENCIA as d LEFT join GESTVIFTRA as n ON D.NUMERO_DOCUMENTO=n.NUMERO_DOCUMENTO WHERE n.CODIGO_ITEM IS NULL group by d.NUMERO_DOCUMENTO) as t";
        ...
        public void cargar_denominador(DataGridView dgv)
        {
            try
            {
                using (SqlConnection cnn = Conexion.ObternerConexion())
                {
                    ...
                    SqlDataAdapter da;
                    DataTable dt;
                    da = new SqlDataAdapter("SELECT * FROM DENOMINADORSI07", cnn);
                    dt = new DataTable();
                    da.Fill(dt);
                    dgv.DataSource = dt;
                }
        ...
        public void cargar_numerador(DataGridView dgv)
        {
            try
            {
                using (SqlConnection cnn = Conexion.ObternerConexion())
                {
                    ...
                    SqlDataAdapter da;
                    DataTable dt;
                    da = new SqlDataAdapter("SELECT * FROM GESTVIFTRA", cnn);
                    dt = new DataTable();
                    da.Fill(dt);
                    dgv.DataSource = dt;
                }
        ...
        public void falta(DataGridView dgv)
        {
            try
            {
                using (SqlConnection cnn = Conexion.ObternerConexion())
                {
                    ...
                    da = new SqlDataAdapter("select * from GESPOSITIVAVIOLENCIA as d LEFT join GESTVIFTRA as n ON D.NUMERO_DOCUMENTO=n.NUMERO_DOCUMENTO WHERE n.CODIGO_ITEM IS NULL", cnn);
                    dt = new DataTable();
                    da.Fill(dt);
                    dgv.DataSource = dt;
                    cnn.Close();
...
//sirve para ver las usuarias que fueron tamizadas
        public void verTamizadas(DataGridView dgv)
        {
            try
            {
                using (SqlConnection cnn = Conexion.ObternerConexion())
                {
                    ...
                    da = new SqlDataAdapter("select * from DENOMINADORSI07 as d left join DENOMINADORSI07TAMIZAJE as n on d.numero_documento=n.numero_documento where (n.codigo_item is null or n.codigo_item='')", cnn);
                    dt = new DataTable();
                    da.Fill(dt);
                    dgv.DataSource = dt;
                    cnn.Close();
